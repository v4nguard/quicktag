...
pub const CLASSES_DESTINY_TTK: &[TagClass] = &[
    ...
    class!(0x80800861 s_pattern_component),
...
pub const CLASSES_DESTINY_ROI: &[TagClass] = &[
    ...
    class!(0x80800715 s_pattern_component),
    class!(0x80800734 s_entity),
...
pub const CLASSES_DESTINY_SK: &[TagClass] = &[
    ...
    class!(0x80809C04 s_pattern_component),
...
pub const CLASSES_DESTINY_BL: &[TagClass] = &[
    ...
    class!(0x80809B06 s_pattern_component),
...
pub const CLASSES_GOLIATH: &[TagClass] = &[
    ...
    class!(0x8080BAF8 s_PROBABLY_USELESS),
    class!(0x808031DC s_scope),
    class!(0x808031D8 s_technique),
    class!(0x8080BAAD s_pattern),
    class!(0x8080BADB s_pattern_component),
    class!(0x808081E8 s_particle_system),
    class!(0x8080B128 s_wwise_event),
    class!(0x8080AB27 s_bubble_parent),
    class!(0x8080A7BB s_bubble_definition),
    class!(0x8080A7C1 s_map_container),
    class!(0x8080B1A7 s_map_node_table),
    class!(0x8080B3F5 s_map_node_entry),
    class!(0x808085B0 s_static_instances_collection_component),
    class!(0x80808563 s_static_terrain_patches_component),
    class!(0x8080A7F5 s_occlusion_bounds),
    class!(0x8080A7F7 s_object_occlusion_bounds),
    class!(0x80806F07 s_dynamic_model),
    class!(0x80806EC5 s_dynamic_mesh),
    class!(0x80806ECB s_dynamic_mesh_part),
    class!(0x80806D97 s_dynamic_mesh_material_variants),
    class!(0x80808635 s_static_mesh),
    class!(0x80808620 s_static_mesh_data),
    class!(0x80808627 s_static_mesh_part),
    class!(0x80808628 s_static_mesh_group),
    class!(0x8080A7F1 s_static_mesh_instances),
    ...
    class!(0x8080856A s_terrain_mesh_part),
    class!(0x8080B61C s_render_globals),
    class!(0x8080A7C9 s_unk_8080870f),
    class!(0x80808070 s_render_globals_data),
    class!(0x80807F6A s_render_global_lookup_textures),
    class!(0x80808075 s_render_global_scope),
    class!(0x80808074 s_render_global_pipelines),
    class!(0x80808661 s_vertex_input_layouts),
    class!(0x80808664 s_vertex_input_layout_mapping),
    class!(0x80808667 s_vertex_layout),
    class!(0x80808668 s_vertex_input_element_sets),
    class!(0x8080866A s_vertex_input_element_set),
    class!(0x8080866D s_vertex_input_element),
    class!(0x808031DC s_scope),
    class!(0x808031D8 s_technique),
    class!(0x808086C6 s_material_texture_assignment),
    class!(0x8080013F s_sampler_reference),
    class!(0x8080B9B8 s_localized_strings),
    class!(0x8080BACC s_8080bacc @size(24)),
    class!(0x80808682 s_80808682 @size(8)),
    class!(0x8080854B s_chunked_light_collection),
    class!(0x80808557 s_deferred_light),
];
